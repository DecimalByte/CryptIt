# CryptIt! Version 1.0 - 05/2023
# Made by @DecimalByte
# Author : DILEM Boussad
    ...
    def rot13_decryption(self):
       ...
       # Message inputted by user
        ...
        if decryp_text != "":
            ...
            # Error if the input is empty
            messagebox.showerror(title="Error", message="Enter a message to decrypt!")
...
class caesar:
    def __init__(self):
        ...
        self.label1 = Label(self.root, text="Input a key : ", font=('Arial', 16))
        ...
        # Encrypt button
        self.button = Button(self.buttonManager, width=18, bg="green", fg="white", bd=0, font=('Arial', 14), text="Encrypt", command=self.caesar_encryption)
        self.button.grid(row=0, column=0)

        # Decrypt button
        self.button1 = Button(self.buttonManager, width=18, bg="red", fg="white", bd=0, font=('Arial', 14), text="Decrypt", command=self.caesar_decryption)
        self.button1.grid(row=0, column=1)
    ...
    def caesar_encryption(self):
        ...
        if self.entry1.get() == "":
            ...
            messagebox.showerror(title="Error", message="Input a key!")
...
class Main:
    if __name__ == "__main__":
        ...
        button1 = Button(buttonManager, width=18, text="Caeser Cipher", bg="#00a7e1", fg="white", bd=0, font=('Arial', 14), command=caesar)
        button1.grid(row=0, column=1)

        buttonManager.pack(fill="x")

        # Credits
        name = Label(main, text="Made by @DecimalByte\n Version 1.0 ", font=('Consolas', 12))
